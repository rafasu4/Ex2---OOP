...
public class DWGraph_Algo implements dw_graph_algorithms {
    ...
    /**
     * to check if the directed graph is connected I make DFS  on both , the graph and the Replaced graph.
    ...
    /**
     * This algorithm checks if from the current node there is a path
     * to all other nodes.
    ...
    /**
     *  This method checks whats the best way from all the nodes to the srcNode and put it into a hashmap.
     ...
     *  smalled distance , this way i used Heap TO GIVE ME  the smalled dis everytime i choose the nest node to travel.
     *  i used object "NodeForHeap" that had a "dis" inside her and the MinHeap works on this Dis.
     * @param src
     * @return HashODis
     */
